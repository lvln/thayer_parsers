...
any_18bit :	  X00  any_byte any_byte | '\x01' any_byte any_byte | 
		'\x02' any_byte any_byte | '\x03' any_byte any_byte ;
any_15bit :	any_7bit any_byte ;
any_11bit :	  X00  any_byte | '\x01' any_byte | '\x02' any_byte | '\x03' any_byte | 
		'\x04' any_byte | '\x05' any_byte | '\x06' any_byte | '\x07' any_byte ;
any_byte :	  X00  | '\x01' | '\x02' | '\x03' | '\x04' | '\x05' | '\x06' | '\x07' | 
...
any_7bit :	  X00  | '\x01' | '\x02' | '\x03' | '\x04' | '\x05' | '\x06' | '\x07' | 
		'\x08' | '\x09' | '\x0a' | '\x0b' | '\x0c' | '\x0d' | '\x0e' | '\x0f' | 
  		'\x10' | '\x11' | '\x12' | '\x13' | '\x14' | '\x15' | '\x16' | '\x17' | 
  		'\x18' | '\x19' | '\x1a' | '\x1b' | '\x1c' | '\x1d' | '\x1e' | '\x1f' | 
  		'\x20' | '\x21' | '\x22' | '\x23' | '\x24' | '\x25' | '\x26' | '\x27' | 
