...
element:
       rulename | group | option | char_val | num_val | prose_val | any_byte
       ;
...
char_val:
        case_insensitive_string | case_sensitive_string | single_char
        ;
...
uint8:
     'u' '8' one_star_digit opt_uint8
     ;

int8:
    'i' '8' opt_neg one_star_digit opt_int8
    ;

uint16_le:
         'u' '1' '6' '_' 'l' 'e' one_star_digit opt_uint16
         ;

int16_le:
        'i' '1' '6' '_' 'l' 'e' opt_neg one_star_digit opt_int16
        ;

uint16_be:
         'u' '1' '6' '_' 'b' 'e' one_star_digit opt_uint16
         ;

int16_be:
        'i' '1' '6' '_' 'b' 'e' opt_neg one_star_digit opt_int16
        ;

uint32_le:
         'u' '3' '2' '_' 'l' 'e' one_star_digit opt_uint32
         ;

int32_le:
        'i' '3' '2' '_' 'l' 'e' opt_neg one_star_digit opt_int32
        ;

uint32_be:
         'u' '3' '2' '_' 'b' 'e' one_star_digit opt_uint32
         ;

int32_be:
        'i' '3' '2' '_' 'b' 'e' opt_neg one_star_digit opt_int32
        ;

uint64_le:
         'u' '6' '2' '_' 'l' 'e' one_star_digit opt_uint64
         ;

int64_le:
        'i' '6' '2' '_' 'l' 'e' opt_neg one_star_digit opt_int64
        ;

uint64_be:
         'u' '6' '2' '_' 'b' 'e' one_star_digit opt_uint64
         ;

int64_be:
        'i' '6' '2' '_' 'b' 'e' opt_neg one_star_digit opt_int64
        ;

float_le:
        'f' '_' 'l' 'e' float_val opt_float
        ;

float_be:
        'f' '_' 'b' 'e' float_val opt_float
        ;
...
opt_single_char:
               /* empty */ | one_star_dot_single_char | dash_single_char | one_star_comma_single_char
               ;

one_star_dot_single_char:
                        '.' quoted_char | one_star_dot_single_char '.' quoted_char
                        ;
...
one_star_comma_single_char:
                          ',' quoted_char | one_star_comma_single_char ',' quoted_char
                          ;
...
opt_bin_val:
           /* empty */ | one_star_dot_bit | dash_bit
           ;
...
opt_int8:
        /* empty */ | one_star_dot_sig_digit | dash_sig_digit | one_star_comma_sig_digit
        ;

/* uint16_le and uint16_be */

opt_uint16:
          /* empty */ | one_star_dot_digit | dash_digit | one_star_comma_digit
          ;

/* int16_le and int16_be */

opt_int16:
         /* empty */ | one_star_dot_sig_digit | dash_sig_digit | one_star_comma_sig_digit
         ;

/* uint32_le and uint32_be */

opt_uint32:
          /* empty */ | one_star_dot_digit | dash_digit | one_star_comma_digit
          ;

/* int32_le and int32_be */

opt_int32:
         /* empty */ | one_star_dot_sig_digit | dash_sig_digit | one_star_comma_sig_digit
         ;

/* uint64_le and uint64_be */

opt_uint64:
          /* empty */ | one_star_dot_digit | dash_digit | one_star_comma_digit
          ;

/* int64_le and int64_be */

opt_int64:
         /* empty */ | one_star_dot_sig_digit | dash_sig_digit | one_star_comma_sig_digit
         ;

/* float_le and float_be */

float_val:
         opt_neg one_star_digit '.' one_star_digit
         ;

opt_float:
         /* empty */ | one_star_dot_float_val | dash_float_val | one_star_comma_float_val
         ;

one_star_dot_float_val:
                      '.' float_val | one_star_dot_float_val '.' float_val
                      ;
...
one_star_comma_float_val:
                        ',' float_val | one_star_comma_float_val ',' float_val
                        ;
...
one_star_dot_sig_digit:
                      '.' opt_neg one_star_digit | one_star_dot_sig_digit '.' opt_neg one_star_digit
                      ;

dash_sig_digit:
              '-' opt_neg one_star_digit
              ;

one_star_comma_sig_digit:
                        ',' opt_neg one_star_digit | one_star_comma_sig_digit ',' opt_neg one_star_digit
                        ;
