...
comments: /* empty */ | comments commen ;
...
alternationss:
    /* empty */ | alternationss alternatio
    ;
...
alternations:
    /* empty */ | alternations c-wsp
    ;

// concatenation = repetition *(1*c-wsp repetition)
concatenation:
    repetition concatenationss
    ;

concatenationss:
    /* empty */ | concatenationss concatenatio
    ;

concatenatio:
    concatenations repetition
    ;

concatenations:
    c-wsp | concatenations c-wsp
    ;
