...
./extractonebyid rural.tlog ../../mavlink_single_message_repeat/tests.src/pass.${passSeed} 29
let passOne=passSeed
let passSeed++

# Bring in all the messages from the flight
./extractbymessageid rural.tlog ../../mavlink_single_message_repeat/tests.src/pass.${passSeed} 29
let passAll=passSeed
let passSeed++

# Create a test with the incorrect message type
./extractonebyid rural.tlog ../../mavlink_single_message_repeat/tests.src/fail.${failSeed} 30
let fail=failSeed
let failSeed++
